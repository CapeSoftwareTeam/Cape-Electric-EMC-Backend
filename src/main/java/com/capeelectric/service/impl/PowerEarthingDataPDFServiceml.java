...
//				table18.setSpacingAfter(10f); // Space after table
				...
				PdfPCell cell310 = new PdfPCell(new Paragraph(electroicSys.getNamePlateData(), font9));
				...
				PdfPCell cell314 = new PdfPCell(new Paragraph("Remote" + electroicSys.getEmergencyTripRemote(), font9));
				...
				PdfPCell cell3122 = new PdfPCell(new Paragraph(electroicSys.getEmergencyTripLocal() + "none", font9));
